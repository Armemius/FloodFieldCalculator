...
ffc::Vertical_left_gap_collimator::Vertical_left_gap_collimator(double gap, double offset)
    : _gap(gap), _offset(offset) {}

bool ffc::Vertical_left_gap_collimator::check_intersection(measures::coords ray_start,

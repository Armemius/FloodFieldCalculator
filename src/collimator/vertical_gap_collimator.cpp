...
ffc::Vertical_gap_collimator::Vertical_gap_collimator(double gap, double offset)
    : _gap(gap), _offset(offset) {}

bool ffc::Vertical_gap_collimator::check_intersection(measures::coords ray_start,
  ...
  return Z >= this->_gap / 2.0 || Z <= -this->_gap / 2.0;
}